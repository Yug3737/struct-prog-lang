...
def parse_while_statement(tokens):
    ...
    node = {"tag": "while", "condition":condition, "then":then_statement}
...
def test_parse_while_statement():
    ...
    assert ast == {'tag': 'if', 'condition': {'tag': 'number', 'value': 1, 'position': 3}, 'then': {'tag': 'print', 'value': {'tag': 'number', 'value': 2, 'position': 11}}, 'else': {'tag': 'print', 'value': {'tag': 'number', 'value': 3, 'position': 23}}}
    ast, tokens = parse_if_statement(tokenize("if(1){print(2);print(-2)}else{print(3);print(-3)}"))
    assert ast == {'tag': 'if', 'condition': {'tag': 'number', 'value': 1, 'position': 3}, 'then': {'tag': 'list', 'statement': {'tag': 'print', 'value': {'tag': 'number', 'value': 2, 'position': 12}}, 'list': {'tag': 'list', 'statement': {'tag': 'print', 'value': {'tag': 'negate', 'value': {'tag': 'number', 'value': 2, 'position': 22}}}, 'list': None}}, 'else': {'tag': 'list', 'statement': {'tag': 'print', 'value': {'tag': 'number', 'value': 3, 'position': 36}}, 'list': {'tag': 'list', 'statement': {'tag': 'print', 'value': {'tag': 'negate', 'value': {'tag': 'number', 'value': 3, 'position': 46}}}, 'list': None}}}
